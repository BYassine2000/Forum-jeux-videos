...
<nav id="navbar">
    <div class="logo">
        <a href="/JVI/" style="text-decoration: none; color: white;">JVI</a>
    </div>
    ...
    <?php } else { ?>
        <li><a href="ajout_publication">Ajout Publications</a></li>
        <li><a href="mes publications" style="color: #00FA9A;">Mes Publications</a></li>
...
switch ($page) {
    ...
    case "ajout_publication" :
        require_once("gestion_ajout_publications.php");
        break;
    case "contact" :
    ...
    case "cgv" :
        ...
        break;
    case "publications" :
        require_once("gestion_publications.php");
        break;
    case "publication" :
        require_once("gestion_publication.php");
        break;
    case "connexion" :
    ...
    case "mes publications" :
        require_once("gestion_mes_publications.php");
        break;
    case "messages" :
...
<?php } ?>
    <footer>
        ...
        <p class="copyright">JVI © 2023 - Tout droits réservés.</p>
    </footer>
</div>
<!-- / FOOTER -->
