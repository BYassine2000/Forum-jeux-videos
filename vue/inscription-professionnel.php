...
if (!isset($_SESSION['utilisateur_connecte'])) {
  header("Location: index"); // Rediriger vers la page d'inscription pour les particuliers
    ...
    <div class="container mt-4 mb-5">
        <div class="row d-flex justify-content-center">
            <div class="card" style="max-width: 40rem;">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label for="nom" class="form-label">Votre nom d'entreprise</label>
                    ...
                    <div class="mb-3">
                        <label for="statut" class="form-label">Votre statut</label>
                ...
                <div class="card-footer">
                    <div class="row d-flex justify-content-center">
                        <div class="col-6">
                            <button type="submit" name="InscriptionProfessionnel" class="btn btn-lg w-100 text-light fw-bold" style="background-color: #008080; border-color: #AFEEEE;">
                                Créer un compte
                            </button>
                        </div>
                    </div>
